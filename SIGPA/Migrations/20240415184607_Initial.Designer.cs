...
namespace SIGPA.Migrations
{
    ...
    [Migration("20240415184607_Initial")]
            ...
            modelBuilder.Entity("SIGPA.Models.Partida", b =>
                {
                    ...
                    b.Property<int>("ResiduosIdResiduo")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIGPA.Models.RecolectaControlCalidad", b =>
                {
                    ...
                    b.Property<int>("ControlCalidadIdControlCalidad")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RecolectaResiduosIdRecolectaResiduos")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ControlCalidadIdControlCalidad");

                    b.HasIndex("RecolectaResiduosIdRecolectaResiduos");
            ...
            modelBuilder.Entity("SIGPA.Models.RecolectaResiduos", b =>
                {
                    ...
                    b.Property<int>("RutaRecolectaIdRutaRecolecta")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RutaRecolectaIdRutaRecolecta");

                    b.ToTable("RecolectaResisiduos");
                });
            ...
            modelBuilder.Entity("SIGPA.Models.Residuos", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdResiduo"));
            ...
            modelBuilder.Entity("SIGPA.Models.Partida", b =>
                {
                    ...
                    b.HasOne("SIGPA.Models.Residuos", "Residuos")
                        .WithMany()
                        .HasForeignKey("ResiduosIdResiduo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SIGPA.Models.RecolectaControlCalidad", b =>
                {
                    b.HasOne("SIGPA.Models.ControlCalidad", "ControlCalidad")
                        .WithMany()
                        .HasForeignKey("ControlCalidadIdControlCalidad")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SIGPA.Models.RecolectaResiduos", "RecolectaResiduos")
                        .WithMany()
                        .HasForeignKey("RecolectaResiduosIdRecolectaResiduos")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SIGPA.Models.RecolectaResiduos", b =>
                {
                    ...
                    b.HasOne("SIGPA.Models.RutaRecolecta", "RutaRecolecta")
                        .WithMany()
                        .HasForeignKey("RutaRecolectaIdRutaRecolecta")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
