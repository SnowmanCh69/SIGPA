...
namespace SIGPA.Repositories
{
    public interface IResiduosPartidaRepository
    {
        ...
        Task<ResiduosPartida> CreateResiduosPartida(int idPartida, int idResiduos, int cantidadRegistrada);
    ...
    public class ResiduosPartidaRepository : IResiduosPartidaRepository
    {
        ...
        public async Task<ResiduosPartida> CreateResiduosPartida(int idPartida, int idResiduos, int cantidadRegistrada)
        {
